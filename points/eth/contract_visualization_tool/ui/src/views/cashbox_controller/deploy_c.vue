...
import { contractByteCode, libraries } from "./data"
...
export default class CashboxControllerDeployC extends Vue {
  private params = {
    ...
    decisionMaker: "",
    nftHolder: "",
    DContractAddr: this.$store.state.cashboxDataContractAddress,
  }
  ...
  private getAddress(): void {
    ...
    getTxReceipt(this.$store.state.cashboxChainAddress, this.deployTxHash)
      .then((receipt: TransactionReceipt) => {
        ...
        this.$store.state.cashboxControllerContractAddress = receipt.contractAddress;
