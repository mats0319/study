<template>
  <div class="eth-manage">
    ...
    <el-collapse
      v-show="chainAddr.length > 0 && contractAddress.length > 0"
      class="em-invokes"
...
import { contractAddress, chainAddr } from "@/views/eth/data";
import {
...
export default class ETHManage extends Vue {
  ...
  private replaceETHReceiverAddress(): void {
    ...
    replaceETHReceiver(this.$store.state.address, this.contractAddress, this.replaceETHReceiverInput)
      .then((data: any) => {
  ...
  private getETHReceiverAddress(): void {
    getETHReceiver(this.chainAddr, this.contractAddress)
      .then((address: any) => {
  ...
  private addWithdrawACashOperators(): void {
    ...
    addACashOperators(this.$store.state.address, this.contractAddress, this.addACashAddrs)
      .then((data: any) => {
        this.$message.success("调用成功")
  ...
  private delWithdrawACashOperators(): void {
    ...
    delACashOperators(this.$store.state.address, this.contractAddress, this.delACashAddrs)
      .then((data: any) => {
        this.$message.success("调用成功")
  ...
  private getWithdrawACashOperators(): void {
    getACashOperators(this.chainAddr, this.contractAddress)
      .then((address: any) => {
  ...
  private addWithdrawBrokerageOperators(): void {
    ...
    addBrokerageOperators(this.$store.state.address, this.contractAddress, this.addBrokerageAddrs)
      .then((data: any) => {
        this.$message.success("调用成功")
  ...
  private delWithdrawBrokerageOperators(): void {
    ...
    delBrokerageOperators(this.$store.state.address, this.contractAddress, this.delBrokerageAddrs)
      .then((data: any) => {
        this.$message.success("调用成功")
  ...
  private getWithdrawBrokerageOperators(): void {
    getBrokerageOperators(this.chainAddr, this.contractAddress)
      .then((address: any) => {
