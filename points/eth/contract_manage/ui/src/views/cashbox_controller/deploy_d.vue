...
import { chainAddr, cashboxDataContractByteCode, libraries, cashboxDataContractAddress } from "./data"
  ...
  private getAddress(): void {
    ...
    getTxReceipt(this.chainAddr, this.deployTxHash)
      .then((receipt: TransactionReceipt) => {
        ...
        this.$store.state.cashboxDContractAddress = receipt.contractAddress as string;
