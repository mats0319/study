...
export default class ETHLibrary extends Vue {
  ...
  private getAddress(): void {
    ...
    getTxReceipt(this.$store.state.ethChainAddress, this.libraries[this.selectedIndex].txHash, (receipt: TransactionReceipt) => {
      ...
      this.$store.state.ethLibraries[this.selectedIndex] = receipt.contractAddress as string;
    });
  }
}
</script>
